#!/bin/bash
# setup_vm.sh — One-command setup for NSE Nifty 50 Trading Agent on Ubuntu 22.04
# Run as: bash setup_vm.sh
set -e

echo "=== NSE Nifty 50 Trading Agent — Cloud VM Setup ==="
...
echo "1. Upload your trading agent files to ~/nse-agent/"
